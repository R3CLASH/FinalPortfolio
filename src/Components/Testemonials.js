    ...
    <div className="border-b-2">
      <div class="container my-24 px-6 mx-auto">
        <section class="mb-32 text-gray-800 text-center">
          <h2 class="text-3xl font-semibold mb-12 text-orange-500">
            Testimonials
          </h2>
          ...
          <div class="grid md:grid-cols-3 gap-x-6 lg:gap-x-12">
            <div class="mb-12 md:mb-0">
              ...
              <h6 class="font-medium text-orange-500 mb-4">Web Developer</h6>
              <p class="mb-4">
                <svg
                  aria-hidden="true"
                  focusable="false"
            ...
            <div class="mb-12 md:mb-0">
              ...
              <h6 class="font-medium text-orange-500 mb-4">Graphic Designer</h6>
              <p class="mb-4">
                <svg
                  aria-hidden="true"
                  focusable="false"
            ...
            <div class="mb-0">
              ...
              <h6 class="font-medium text-orange-500 mb-4">
